// CUDA WebShader 0.1.0. Generated from kernel makeKeys.
@group(0) @binding(0) var<storage, read> b_P: array<f32>;
@group(0) @binding(1) var<storage, read_write> b_Keys: array<u32>;
@group(0) @binding(2) var<storage, read_write> b_Order: array<u32>;
...
fn f_cw_buffer_helper_0(cw_buffer_arg_0: i32, cw_arg_id: i32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) -> vec3<f32> {
  ...
  var v_a: vec3<f32> = f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), v_b, cw_thread, cw_block, cw_grid);
  if ((v_type == 0i)) {
    let cw_argument_index_3 = (cw_buffer_offset_0 + (v_b + 7i));
    let cw_argument_index_4 = (cw_buffer_offset_0 + (v_b + 11i));
    var v_r: f32 = (max(b_P[cw_argument_index_3], b_P[cw_argument_index_4]) + 0.002f);
    return (f_min3(v_a, f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), (v_b + 4i), cw_thread, cw_block, cw_grid), cw_thread, cw_block, cw_grid) - vec3<f32>(v_r, v_r, v_r));
  }
  if ((v_type == 2i)) {
    return (v_a - f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), (v_b + 4i), cw_thread, cw_block, cw_grid));
  }
...
fn f_cw_buffer_helper_1(cw_buffer_arg_0: i32, cw_arg_id: i32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) -> vec3<f32> {
  var cw_buffer_offset_0: i32 = cw_buffer_arg_0;
  var v_id: i32 = cw_arg_id;
  var v_b: i32 = (v_id * 24i);
  var v_type: i32 = i32(b_P[(cw_buffer_offset_0 + (v_b + 3i))]);
  ...
  var v_a: vec3<f32> = f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), v_b, cw_thread, cw_block, cw_grid);
  if ((v_type == 0i)) {
    let cw_argument_index_5 = (cw_buffer_offset_0 + (v_b + 7i));
    let cw_argument_index_6 = (cw_buffer_offset_0 + (v_b + 11i));
    var v_r: f32 = (max(b_P[cw_argument_index_5], b_P[cw_argument_index_6]) + 0.002f);
    return (f_max3(v_a, f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), (v_b + 4i), cw_thread, cw_block, cw_grid), cw_thread, cw_block, cw_grid) + vec3<f32>(v_r, v_r, v_r));
  }
  if ((v_type == 2i)) {
    return (v_a + f_cw_buffer_helper_2((cw_buffer_offset_0 + 0i), (v_b + 4i), cw_thread, cw_block, cw_grid));
  }
...
fn f_cw_buffer_helper_2(cw_buffer_arg_0: i32, cw_arg_i: i32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) -> vec3<f32> {
  var cw_buffer_offset_0: i32 = cw_buffer_arg_0;
  ...
  return vec3<f32>(b_P[cw_argument_index_7], b_P[cw_argument_index_8], b_P[cw_argument_index_9]);
}
...
fn main(
  ...
  b_Order[v_i] = u32(v_i);
  if ((b_P[((v_i * 24i) + 3i)] < 0.0f)) {
    b_Keys[v_i] = 4294967295u;
    return;
  }
  var v_p: vec3<f32> = ((f_cw_buffer_helper_0(0i, v_i, cw_thread, cw_block, cw_grid) + f_cw_buffer_helper_1(0i, v_i, cw_thread, cw_block, cw_grid)) * vec3<f32>(0.5f));
  var v_x: u32 = u32((f_sat(cw_divide_f32((v_p.x + 12.0f), 24.0f), cw_thread, cw_block, cw_grid) * 1023.0f));
  var v_y: u32 = u32((f_sat(cw_divide_f32((v_p.y + 1.0f), 18.0f), cw_thread, cw_block, cw_grid) * 1023.0f));
  var v_z: u32 = u32((f_sat(cw_divide_f32((v_p.z + 12.0f), 24.0f), cw_thread, cw_block, cw_grid) * 1023.0f));
  b_Keys[v_i] = ((f_spread(v_x, cw_thread, cw_block, cw_grid) | (f_spread(v_y, cw_thread, cw_block, cw_grid) << u32(1i))) | (f_spread(v_z, cw_thread, cw_block, cw_grid) << u32(2i)));
}
