// CUDA WebShader 0.1.0. Generated from kernel initCamera.
...
fn f_cw_buffer_helper_0(cw_buffer_arg_0: i32, cw_arg_eye: vec3<f32>, cw_arg_yaw: f32, cw_arg_pitch: f32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) {
  ...
  f_cw_buffer_helper_1((cw_buffer_offset_0 + 0i), 0i, v_eye, cw_thread, cw_block, cw_grid);
  ...
  f_cw_buffer_helper_1((cw_buffer_offset_0 + 0i), 4i, (v_eye + v_f), cw_thread, cw_block, cw_grid);
...
fn main(
  ...
  b_C[44i] = 1.0f;
  f_cw_buffer_helper_0(0i, vec3<f32>(2.0f, 1.72f, 18.0f), 3.14159265359f, 0.0f, cw_thread, cw_block, cw_grid);
}
